...
public class TestCart {
    public static void main(String[] args) {
        ...
        cart.addItem(product.getProductCode(), new ClassicModelLineItem(product, 5));   //นำ product ใส่ตะกร้า 5 ชิ้น
        product = productRepository.findProduct("S12_3380");
        cart.addItem(product.getProductCode(), new ClassicModelLineItem(product)); //นำ product ใส่ตะกร้า ชิ้นเดียว
